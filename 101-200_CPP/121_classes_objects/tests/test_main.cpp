/*
 * Test Suite for Program 121: Classes and Objects
 *
 * Tests for Classes and Objects functionality
 */
...
int main() {
    std::cout << "=== Running Tests for Program 121: Classes and Objects ===" << std::endl;
    std::cout << std::endl;
